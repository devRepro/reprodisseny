          ...
          <div class="mb-8">
            <div v-if="product.badges?.length" class="flex gap-2 mb-2">
              <span
                ...
                :key="b"
                class="inline-block bg-secondary text-secondary-foreground text-xs font-semibold px-2.5 py-0.5 rounded-full"
              >
                {{ b }}
              </span>
            </div>
            ...
            <p v-if="product.description" class="mt-4 text-lg text-muted-foreground">
              {{ product.description }}
            </p>
          </div>
          ...
          <div class="lg:sticky lg:top-24">
            <div class="border rounded-2xl bg-card p-6 shadow-sm">
              <h2 class="text-2xl font-bold mb-1">
                Presupuesto para {{ product.title }}
              </h2>
