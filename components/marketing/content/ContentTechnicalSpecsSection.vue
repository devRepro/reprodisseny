...
const highlights = [
    {
        ...
        label: "01",
        title: "Formato",
        description: "Tipo de abanico, medida y superficie imprimible.",
    },
    {
        icon: FileCheck2,
        label: "02",
...
<template>
    <section class="space-y-6">
        ...
        <div class="rounded-2xl border border-border/70 bg-card p-5 shadow-sm md:p-7">
            <ContentDetailsSection :section="section" :show-header="showHeader" class="content-details--technical" />
        </div>
    </section>
</template>
