...
onMounted(() => {
  ...
  const observer = new IntersectionObserver(
    ...
    // Ajustado para que el cambio de tab se sienta más natural al hacer scroll
...
function scrollToSection(id: string) {
  ...
  // Compensación por la altura de la navegación flotante
  const yOffset = -100;
...
<style scoped>
/* Ocultar barra de scroll en la navegación flotante para móviles pero permitir swipe */
