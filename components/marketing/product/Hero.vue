...
<template>
  <article
    ...
    "
  >
    <div class="grid items-start gap-10 lg:grid-cols-[minmax(0,1fr)_420px] lg:gap-14">
      <section class="min-w-0 self-start">
        <header class="space-y-4">
          <h1
            class="truncate text-2xl font-semibold tracking-tight text-foreground md:text-3xl"
            :title="productTitle"
            itemprop="name"
          >
            {{ productTitle }}
